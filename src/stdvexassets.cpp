...
ACTION stdvexassets::changeauthor( name author, name newauthor, name owner, vector<uint64_t>& assetids, string memo ) {
...
ACTION stdvexassets::saechauthor( name author, name newauthor, name owner, vector< tuple<uint64_t, name> >& assetids, string memo ) {
	require_recipient( author );
}

ACTION stdvexassets::authorreg( name author, string dappinfo, string fieldtypes, string priorityimg ) {
...
ACTION stdvexassets::authorupdate( name author, string dappinfo, string fieldtypes, string priorityimg ) {
...
ACTION stdvexassets::create( name author, name category, name owner, string idata, string mdata, bool requireclaim ) {
...
ACTION stdvexassets::saecreate( name author, name category, name owner, string idata, string mdata, uint64_t assetid, bool requireclaim ) {
	require_recipient( author );
}

ACTION stdvexassets::createlog( name author, name category, name owner, string idata, string mdata, uint64_t assetid, bool requireclaim ) {

	require_auth( get_self() );
}

ACTION stdvexassets::claim( name claimer, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::saeclaim(name author, name claimer, vector< tuple<uint64_t, name> >& assetids) {
	require_recipient(author);
}

void stdvexassets::check_empty_vector( vector<uint64_t>& vector_ids, string vector_name ) {

	check( !(vector_ids.size() == 0), "Please add values to parameter: " + move(vector_name) );
}

void stdvexassets::check_memo_size( const string & memo ) {
...
ACTION stdvexassets::transfer( name from, name to, vector<uint64_t>& assetids, string memo ) {
...
name stdvexassets::get_payer( name author, name category, uint64_t id )
{
	name result = ""_n;
	auto author_index = arampayert.template get_index< "author"_n >();
...
ACTION stdvexassets::saetransfer(name author, name from, name to, vector<uint64_t>& assetids, string memo) {
	require_recipient(author);
}

ACTION stdvexassets::update( name author, name owner, uint64_t assetid, string mdata ) {
...
ACTION stdvexassets::offer( name owner, name newowner, vector<uint64_t>& assetids, string memo ) {
...
ACTION stdvexassets::canceloffer( name owner, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::burn( name owner, vector<uint64_t>& assetids, string memo ) {
...
ACTION stdvexassets::saeburn(name author, name owner, vector<uint64_t>& assetids, string memo) {
	require_recipient(author);
}

ACTION stdvexassets::burnflog( name from, name author, asset quantity, string memo ) {
	require_auth(get_self());
}

ACTION stdvexassets::burnnttlog(name owner, vector<uint64_t>& assetids, string memo) {
	require_auth(get_self());
}

ACTION stdvexassets::burnlog( name owner, vector<uint64_t>& assetids, string memo ) {
	require_auth(get_self());
}

ACTION stdvexassets::delegate( name owner, name to, vector<uint64_t>& assetids, uint64_t period, bool redelegate, string memo ) {
...
ACTION stdvexassets::delegatemore( name owner, uint64_t assetidc, uint64_t period ) {
...
ACTION stdvexassets::undelegate( name owner, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::attach( name owner, uint64_t assetidc, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::detach( name owner, uint64_t assetidc, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::attachf( name owner, name author, asset quantity, uint64_t assetidc ) {

	attachdeatch( owner, author, quantity, assetidc, true );
}


ACTION stdvexassets::detachf( name owner, name author, asset quantity, uint64_t assetidc ) {

	attachdeatch( owner, author, quantity, assetidc, false );
}

ACTION stdvexassets::createf( name author, asset maximum_supply, bool authorctrl, string data ) {
...
ACTION stdvexassets::updatef( name author, symbol sym, string data ) {
...
ACTION stdvexassets::issuef( name to, name author, asset quantity, string memo ) {
...
ACTION stdvexassets::transferf( name from, name to, name author, asset quantity, string memo ) {
...
ACTION stdvexassets::offerf( name owner, name newowner, name author, asset quantity, string memo ) {
...
ACTION stdvexassets::cancelofferf( name owner, vector<uint64_t>& ftofferids ) {
...
ACTION stdvexassets::claimf( name claimer, vector<uint64_t>& ftofferids ) {
...
ACTION stdvexassets::burnf( name from, name author, asset quantity, string memo ) {
...
ACTION stdvexassets::openf( name owner, name author, const symbol& symbol, name ram_payer ) {
...
ACTION stdvexassets::closef( name owner, name author, const symbol& symbol ) {
...
uint64_t stdvexassets::getid( id_type type ) {
...
uint64_t stdvexassets::getFTIndex( name author, symbol symbol ) {

	stats statstable( _self, author.value );
	return statstable.require_find(symbol.code().raw(), "token with symbol does not exist")->id;
}

void stdvexassets::attachdeatch( name owner, name author, asset quantity, uint64_t assetidc, bool attach ) {
...
void stdvexassets::sub_balancef( name owner, name author, asset value ) {
...
void stdvexassets::add_balancef( name owner, name author, asset value, name ram_payer ) {
...
ACTION stdvexassets::createntt( name author, name category, name owner, string idata, string mdata, bool requireclaim ) {
...
ACTION stdvexassets::createnttlog( name author, name category, name owner, string idata, string mdata, uint64_t assetid, bool requireclaim ) {

	require_auth(get_self());
}

ACTION stdvexassets::updatentt( name author, name owner, uint64_t assetid, string mdata ) {
...
ACTION stdvexassets::claimntt( name claimer, vector<uint64_t>& assetids ) {
...
ACTION stdvexassets::burnntt( name owner, vector<uint64_t>& assetids, string memo ) {
...
ACTION stdvexassets::mdadd( name author, string data ) {
	require_auth( author );
	require_recipient( author );
...
ACTION stdvexassets::mdupdate( uint64_t id, name author, string data ) {
	require_auth( author );
	require_recipient( author );
...
ACTION stdvexassets::mdremove( uint64_t id ) {
...
ACTION stdvexassets::mdaddlog( uint64_t id, name author, string data ) { 
	require_auth(get_self());
}

ACTION stdvexassets::delarampayer( uint64_t id )
{
	require_auth( get_self() );
...
ACTION stdvexassets::setarampayer( name author, name category, bool usearam )
{
	require_auth( author );
	require_recipient( author );
...
void stdvexassets::sendEvent( name author, name rampayer, name seaction, const tuple<Args...> &adata ) 
{
	transaction sevent{};
...
asset stdvexassets::get_supply( name token_contract_account, name author, symbol_code sym_code ) {

	stats statstable( token_contract_account, author.value );
	return statstable.get( sym_code.raw() ).supply;
}

asset stdvexassets::get_balance( name token_contract_account, name owner, name author, symbol_code sym_code ) {
